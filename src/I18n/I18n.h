...
/**
 * Internationalization (i18n) engine for Cav's Unity Shaders.
 *
 ...
 *
 *     ImGui::Text("%s", T("menu.home.welcome", "Welcome to Cav's Unity Shaders"));
 *
 ...
 *   T("menu.home.welcome", "Welcome to Cav's Unity Shaders")
 *
